...
- **npm**: 12.0.2 → 12.1.0 (minor)

## [12.0.1] - 2026-09-21

### Dependencies
- **typescript-eslint**: 8.70.0 → 8.70.1 (patch)
...
- **com.nimbusds:nimbus-jose-jwt**: 10.9.1 → 10.10 (minor)
...
- **@jeap/jeap-jwe-client**: 1.3.7 → 1.3.8 (patch)
...
- **@jeap/jeap-jwe-client**: 1.3.6 → 1.3.7 (patch)
...
- **@jeap/jeap-jwe-client**: 1.3.5 → 1.3.6 (patch)
...
- **typescript-eslint**: 8.68.0 → 8.69.0 (minor)
...
- **@jeap/jeap-jwe-client**: 1.3.4 → 1.3.5 (patch)
