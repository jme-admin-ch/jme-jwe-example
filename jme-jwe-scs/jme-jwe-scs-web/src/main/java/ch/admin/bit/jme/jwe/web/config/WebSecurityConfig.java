...
public class WebSecurityConfig {
     ...
     * (static resources, SPA routes, the JWE discovery endpoints) is public. Requests to
     * {@code /api/**} fall through to the OAuth2 resource server chain contributed by the
     * jeap security starter.
     */
    @Bean
